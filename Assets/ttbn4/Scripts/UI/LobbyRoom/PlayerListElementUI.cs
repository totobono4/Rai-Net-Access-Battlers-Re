...
public class PlayerListElementUI : MonoBehaviour {
    ...
    public void Initialize(int playerIndex) {
        ...
        LobbyRoomManager.Instance.OnClientReadyStateChanged += LobbyRoomReadyManager_OnClientReadyStateChanged;
    ...
    private void UpdatePlayerReady() {
        readyToggle.isOn = LobbyRoomManager.Instance.GetPlayerReady(clientId);
    }
